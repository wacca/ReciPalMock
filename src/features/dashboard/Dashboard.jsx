...
import FocusCard from '../../shared/ui/FocusCard.jsx';
import { KeyHint } from '../../shared/ui/KeyHint.jsx';
import { usePendingCounts, tonePending } from '../../shared/ui/PendingPulse.jsx';
import { loadExpenseApplications, getExpenseIntegrationStatus } from '../expense/expenseApplicationStore';
import { loadLeaveApplications, getLeaveIntegrationStatus } from '../leave/leaveApplicationStore';
import { loadAttendanceTimesheets, getAttendanceIntegrationStatus } from '../attendance/attendanceStore';
import { PERMISSIONS, ROLE_LABELS, ROLES, hasPermission } from '../../shared/utils/permissions';
