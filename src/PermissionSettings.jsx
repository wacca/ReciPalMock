...
const SCREEN_GROUPS = [
    ...
    { title: '申請', screens: [
        { key: 'application', label: '経費申請' }, { key: 'submitted', label: '経費申請済' }, { key: 'approvals', label: '経費承認' },
        { key: 'leave-application', label: '休暇申請' }, { key: 'leave-submitted', label: '休暇申請済' }, { key: 'leave-approvals', label: '休暇承認' },
    ] },
